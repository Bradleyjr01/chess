...
public class ChessBoardTests {
    ...
    @Test
    @DisplayName("Add and Get Resources.Piece")
    public void getAddPiece() {
        ...
        Assertions.assertEquals(piece.getPieceType(), foundPiece.getPieceType(),
                "StartCode.ChessPiece returned by getPiece had the wrong piece type");
        Assertions.assertEquals(piece.getTeamColor(), foundPiece.getTeamColor(),
                "StartCode.ChessPiece returned by getPiece had the wrong team color");
    }


    @Test
    @DisplayName("Reset Resources.Board")
    public void defaultGameBoard() {
        ...
        for (int column = 1; column <= 8; ++column) {
            Assertions.assertEquals(ChessPiece.PieceType.PAWN,
                    ...
                    "Resources.Piece at pawn starting position was not a pawn");
            Assertions.assertEquals(ChessPiece.PieceType.PAWN,
        ...
        for (int column = 1; column <= 8; ++column) {
            ...
            Assertions.assertEquals(ChessGame.TeamColor.WHITE,
                    ...
                    "Resources.Piece at starting position was incorrect color");
            Assertions.assertEquals(ChessGame.TeamColor.WHITE,
        ...
        for (int row = 3; row <= 6; ++row) {
            for (int column = 1; column <= 8; ++column) {
                Assertions.assertNull(board.getPiece(TestFactory.getNewPosition(row, column)),
                        "Resources.Piece in the middle of the board was not reset");
            }
        }
    }
