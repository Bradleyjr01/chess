...
public class ChessGameTests {
    ...
    @Test
    @DisplayName("Normal Make Resources.Move")
    ...
    @Test
    @DisplayName("Invalid Make Resources.Move")
    public void invalidMoves() throws InvalidMoveException {
        ...
        game.makeMove(TestFactory.getNewMove(passoffTests.TestFactory.getNewPosition(1, 6), passoffTests.TestFactory.getNewPosition(3, 4), null));
    ...
    @Test
    @DisplayName("Full Resources.Game Checkmate")
    ...
    @Nested
    @DisplayName("Valid Resources.Move Tests")
    public class ValidMoveTests {
         ...
         */
            ...
            Assertions.assertEquals(validMoves, gameMoves,
                    "StartCode.ChessGame validMoves did not return the correct moves");
        ...
        @Test
        @DisplayName("Resources.Piece Partially Trapped")
        ...
        @Test
        @DisplayName("Resources.Piece Completely Trapped")
         ...
         */
            ...
            Assertions.assertTrue(game.validMoves(position).isEmpty(),
                    "StartCode.ChessGame validMoves returned valid moves for a trapped piece");
        }
        ...
        @Test
        @DisplayName("King Cannot Resources.Move Into Check")
         ...
         */
            ...
            validMoves.add(passoffTests.TestFactory.getNewMove(position, passoffTests.TestFactory.getNewPosition(2, 7), null));
