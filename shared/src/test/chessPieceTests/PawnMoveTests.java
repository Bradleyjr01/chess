...
public class PawnMoveTests {
    ...
    @Test
    @DisplayName("White Single Resources.Move")
    public void emptyBoardWhite() {
        ...
        Assertions.assertEquals(validMoves, pieceMoves,
                "StartCode.ChessPiece pieceMoves did not return the correct moves");
    }


    @Test
    @DisplayName("Black Single Resources.Move")
    ...
    @Test
    @DisplayName("White Double Resources.Move")
    ...
    @Test
    @DisplayName("Black Double Resources.Move")
    ...
    @Test
    @DisplayName("White Resources.Move Blocked")
    public void piecesInWayWhite() {
        ...
        Assertions.assertTrue(pieceMoves.isEmpty(),
                "StartCode.ChessPiece pieceMoves returned valid moves for a trapped piece");
    }


    @Test
    @DisplayName("Black Resources.Move Blocked")
    ...
    @Test
    @DisplayName("Double Resources.Move Blocked")
    ...
    public void capturingByWhite() {
        ...
        Assertions.assertFalse(pieceMoves.contains(badCapture),
                "Resources.Piece moves contained move: " + badCapture + " that would capture a ally piece");

        //expected moves
        ChessMove capture = TestFactory.getNewMove(position, enemyPosition, null);
        Assertions.assertTrue(pieceMoves.contains(capture),
                "Resources.Piece moves did not contain valid move: " + capture + " that would capture an enemy piece");
    ...
    public void capturingByBlack() {
        ...
        Assertions.assertFalse(pieceMoves.contains(badCapture),
                "Resources.Piece moves contained move: " + badCapture + ", which is not a valid move");
